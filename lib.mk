...
ifeq ($(shell test $(PLATFORM_SDK_VERSION) -ge 34 && echo OK),OK)
LOCAL_SHARED_LIBRARIES += android.hardware.graphics.allocator-V2-ndk android.hardware.graphics.common-V4-ndk android.hardware.graphics.mapper@4.0 libc++ libc libcutils libdl libdmabufheap libgralloctypes libhardware libhidlbase liblog libm libnativewindow libutils libz
endif
